...
themes.each_with_index do |theme, index|
  i = index + 1
  content = "---\n"
  content << "title: #{theme.gsub(":", " - ")}\n"
  content << "created_at: 2014-01-06 01:00:00 +0100\n"
  content << "tags: [daily, assignment, photo, shoot, ds#{i}]\n"
  content << "kind: assignment\n"
  content << "index: #{i}\n"
  content << "---\n\n"
  content << "#{theme}\n"
  File.open("content/daily/#{i}.md", 'w') {|f| f.write(content) }
end
